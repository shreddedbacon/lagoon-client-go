...
type AddProjectInput struct {
	...
	OpenshiftID             uint                `json:"openshift"`
...
// ProjectEnvironments is used for the `minimalProjectByName` query
type ProjectEnvironments struct {
	Environments []AllEnvironments `json:"environments,omitempty"`
}

// ProjectEnvironmentsInput is used for the `minimalAllEnvironments` query
